...
public class PackageConfig {
     ...
     * filterDTO包名
     */
    private String filterDTO = "filterDTO";
    ...
    public Map<String, String> getPackageInfo() {
        if (packageInfo.isEmpty()) {
            ...
            packageInfo.put("Dto", this.joinPackage(this.getDto()));
            packageInfo.put("FilterDTO", this.joinPackage(this.getFilterDTO()));
            packageInfo.put("Query", this.joinPackage(this.getQuery()));
            packageInfo.put("Vo", this.joinPackage(this.getVo()));
    ...
    public static class Builder implements IConfigBuilder<PackageConfig> {
        ...
        public Builder filterDTO(@NotNull String filterDTO) {
            this.packageConfig.filterDTO = filterDTO;
            return this;
        }

        public Builder query(@NotNull String query) {
            this.packageConfig.query = query;
            return this;
        }
