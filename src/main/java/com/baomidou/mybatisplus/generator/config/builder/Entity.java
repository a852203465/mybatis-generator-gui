...
public class Entity implements ITemplate {
     ...
     * 覆盖列
     */
    private Set<ColumnOverride> columnOverrides = new HashSet<>();
    ...
    public static class Builder extends BaseBuilder {
         ...
         * @since 3.5.0
         */
        public Builder addTableFills(IFill... tableFill) {
         ...
         * 添加表字段覆盖列
         *
         * @param columnOverride 覆盖列
         * @return this
         * @since 3.5.0
         */
        public Builder addColumnOverrides(ColumnOverride... columnOverride) {
            this.entity.columnOverrides.addAll(Arrays.asList(columnOverride));
            return this;
        }
